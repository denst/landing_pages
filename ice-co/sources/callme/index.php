...
$to = "berzin.evgeny@gmail.com"; //получатель
...
$num = "79165577855"; // ваш номер в формате без + (79218886622)
$prv = "smsc.ru"; // на выбор: sms.ru, infosmska.ru, bytehand.com, sms-sending.ru, smsaero.ru
...
function sendSMS($to, $msg){
	...
	$u['smsc.ru'] = "smsc.ru/sys/send.php?login=".uc($sms_login)."&psw=".uc($sms_pass)."&phones=".uc($num)."&mes=".uc($msg);
...
//get city 
    ...
    $referer = isset($_SERVER['HTTP_REFERER'])? $_SERVER['HTTP_REFERER']: '';
	addToMess("Откуда запрос",($geo['city']." / ".$geo['country_name']." / ".$ip." / ".$referer));


	$headers = "Content-type: text/html; charset=utf-8 \r\n"; 
	$headers.= "From: Ice-Co.ru <".$from.">\r\n"; 
